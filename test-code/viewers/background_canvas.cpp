...
public:
    MyExaminerViewer(Fl_Widget* parent, const char * filename);
    ~MyExaminerViewer();
...
MyExaminerViewer::MyExaminerViewer(Fl_Widget* parent, const char * filename)
...
main(int argc, char ** argv)
{
    ...
    Fl_Widget* window = SoFl::init(argv[0]);
